-- Estabiliza guardado de perfil:
-- 1) role del actor con fallback (evita "No autorizado" por role nulo)
-- 2) casts tolerantes a string vacío en fecha/hora/boolean/timestamp.
